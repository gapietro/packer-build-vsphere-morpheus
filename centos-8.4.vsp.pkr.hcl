...
#  floppy_files         = ["${path.root}/preseed.cfg"]
  iso_urls             = ["http://mirror.cs.pitt.edu/centos/8.4.2105/isos/x86_64/CentOS-8.4.2105-x86_64-dvd1.iso"]
  ...
  folder         = "${var.folder}"
  vm_name        = "centos-84-vsp-pkr-{{ timestamp }}"
...
build {
  sources = ["source.vsphere-iso.centos-84"]
