...
#  floppy_files         = ["${path.root}/preseed.cfg"]
  iso_urls             = ["https://download.rockylinux.org/pub/rocky/8/isos/x86_64/Rocky-8.4-x86_64-dvd1.iso"]
  ...
  folder         = "${var.folder}"
  vm_name        = "rocky-84-vsp-pkr-{{ timestamp }}"
...
build {
  sources = ["source.vsphere-iso.rocky-84"]
